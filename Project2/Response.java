...
public class Response {
	...
	public Response(int id, int gender, int age, int residence, int education, int incomeSource, int maritalStatus,
			int smoker, int year, String q9, int q10, int q11, int q12, int q13, int q14, int q15, String q16, int q17,
			int q18, int q19, int q20, int q21, int q22, String q23, int q24, int q25, int q26, int q27, int q28,
			int q29, int q30) {
		this.Id = id;
	...
	public void printResponse() {
		...
		if (getSmoker() == 1)
			...
			System.out.println("Smoker: No");
	}

	public static void main(String[] args) {
		Response response = new Response(1, 2, 30, 1, 3, 2, 1, 1, 2022, "Some string", 1, 2, 3, 4, 1, 2,
				"Another string", 2, 3, 4, 1, 2, 3, "Yet another string", 3, 4, 1, 2, 3, 4, 5);
